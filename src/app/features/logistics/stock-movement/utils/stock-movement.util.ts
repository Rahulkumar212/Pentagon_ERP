...
export interface MovementSummaryCard {
  id: string;
  title: string;
  value: number;
  description: string;
...
export const MOVEMENT_SUMMARY_DATA: MovementSummaryCard[] = [
  {
    id: 'total-movements',
  ...
  {
    id: 'rejected-movements',
    title: 'Rejected',
    value: 13,
    description: 'Rejected movements',
    icon: 'cancel',
    iconBg: 'bg-red-50',
...
export const STOCK_MOVEMENT_DATA: StockMovementItem[] = [
  {
    id: 'MOV-001',
