...
import { PhysicalApprovalQueueComponent } from './physical-approval-queue/physical-approval-queue.component';

import { TelecallingApprovalQueueComponent } from './telecalling-approval-queue/telecalling-approval-queue.component';
...
@Component({
  ...
  imports: [
    CommonModule,
    PhysicalApprovalQueueComponent,
    TelecallingApprovalQueueComponent,
  ],
  templateUrl: './approval-queue.component.html',
